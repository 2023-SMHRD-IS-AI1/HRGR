          ...
          <div class="col-sm-8 col-lg-4 d-flex justify-content-end gap-5 align-items-center mt-4 mt-sm-0 justify-content-center justify-content-sm-end">
            ...
            <ul class="d-flex justify-content-end list-unstyled m-0">
              <li>
                ...
                <%if(Memberlogin == null){ %>
						<svg width="24" height="24" viewBox="0 0 24 24" id="userIcon">
              ...
              <div class="banner-ad bg-success-subtle block-2" style="background:url('resources/images/fish.png') no-repeat;background-position: right bottom">
                <div class="row banner-content p-5">
                  ...
                  <div class="content-wrapper col-md-7">
                    ...
                    <a href="#" class="d-flex align-items-center nav-link">모아보기 <svg width="24" height="24"><use xlink:href="#arrow-right"></use></svg></a>
                  </div>
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="section-header d-flex flex-wrap justify-content-between my-5">
              ...
              <div class="d-flex align-items-center">
                <a href="#" class="btn-link text-decoration-none">TOP10 모아보기 →</a>
                <div class="swiper-buttons">
            ...
            <div class="products-carousel swiper">
              <div class="swiper-wrapper">
                ...
                <div class="product-item swiper-slide">
                  ...
                  <h3>국내산 바나나</h3>
                  <span class="qty">1손</span><span class="rating"><svg width="24" height="24" class="text-primary"><use xlink:href="#star-solid"></use></svg> 4.5</span>
        ...
        <div class="row">
          <div class="section-header d-flex align-items-center justify-content-between my-5">
            ...
            <div class="btn-wrap align-right">
              <a href="#" class="d-flex align-items-center nav-link">영농일지 모아보기 <svg width="24" height="24"><use xlink:href="#arrow-right"></use></svg></a>
            </div>
          </div>
        </div>
        <div class="row">
            ...
            <article class="post-item card border-0 shadow-sm p-3">
              ...
              <div class="card-body">
                <div class="post-meta d-flex text-uppercase gap-3 my-2 align-items-center">
                  <div class="meta-date"><svg width="16" height="16"><use xlink:href="#calendar"></use></svg>2024.01.12</div>
                  <div class="meta-categories"><svg width="16" height="16"><use xlink:href="#category"></use></svg>농산물</div>
                </div>
                <div class="post-header">
                  <h3 class="post-title">
                    <a href="#" class="text-decoration-none">가현이농장</a>
                  </h3>
                  <p>고양이를 위한 캣닢 농장을 꾸리고 있습니다. 우리 농장은 사람은 취급하지 않기 때문에 사람 먹는건 농약과 사랑으로 키우고 있씁니다. 고양이 먹는건 유기농이에요. </p>
                </div>
              </div>
            </article>
          </div>
          <div class="col-md-4">
            <article class="post-item card border-0 shadow-sm p-3">
              ...
              <div class="card-body">
                <div class="post-meta d-flex text-uppercase gap-3 my-2 align-items-center">
                  <div class="meta-date"><svg width="16" height="16"><use xlink:href="#calendar"></use></svg>2024.01.12</div>
                  <div class="meta-categories"><svg width="16" height="16"><use xlink:href="#category"></use></svg>화도</div>
                </div>
                <div class="post-header">
                  <h3 class="post-title">
          ...
          <div class="col-md-4">
            <article class="post-item card border-0 shadow-sm p-3">
              ...
              <div class="card-body">
                <div class="post-meta d-flex text-uppercase gap-3 my-2 align-items-center">
                  <div class="meta-date"><svg width="16" height="16"><use xlink:href="#calendar"></use></svg>2024.01.12</div>
                  <div class="meta-categories"><svg width="16" height="16"><use xlink:href="#category"></use></svg>그린허브</div>
                </div>
                <div class="post-header">
                  <h3 class="post-title">
