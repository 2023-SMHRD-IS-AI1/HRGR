                ...
                <div class="edit_content">
                  ...
                  <div style="display: flex; justify-content: space-between;">
                    <div class="img-wrapper">
                      <a href="#"><img src="./resources/images/thumb-bananas.png" alt="" style="width: 200px; height: 200px;"></a>
                      <div>바나나 먹으면 나한테 바나나</div>
                    ...
                    <div class="img-wrapper">
                      <a href="#"><img src="./resources/images/thumb-biscuits.png" alt="" style="width: 200px; height: 200px;"></a>
                      <div>내가 만든 쿠키~ <br>너를 위해 구웠지~</div>
                      <span class="rating"><svg width="24" height="24" class="text-primary"><use xlink:href="#star-solid"></use></svg> 4.5</span>
                      <span class="price">6,500원</span>
                    </div>
                    <div class="img-wrapper">
                      <a href="#"><img src="./resources/images/thumb-cucumber.png" alt="" style="width: 200px; height: 200px;"></a>
                      <div>오이잉? 이렇게 맛있다고?!</div>
                      <span class="rating"><svg width="24" height="24" class="text-primary"><use xlink:href="#star-solid"></use></svg> 4.5</span>
                      <span class="price">1,400원</span>
                    </div>
                    <div class="img-wrapper">
                      <a href="#"><img src="./resources/images/thumb-milk.png" alt="" style="width: 200px; height: 200px;"></a>
                      <div>우유가 넘어지면 아야!</div>
                      <span class="rating"><svg width="24" height="24" class="text-primary"><use xlink:href="#star-solid"></use></svg> 4.5</span>
                    ...
                    <div class="diary_content">
                      ...
                      <hr>
                        <div class="diary_img" style="padding: 30px;">
                          <img src="./resources/images/banner-image-1.jpg" alt="이미지에용">
                        </div>
                        <div class="diary_farmer row" style="padding: 30px;">
                          <div class="col-lg-11">
                            <h3>김연성농원</h3>
        
        
                            <h5> 안녕하세요. 김연성농원입니다. 저 진짜 열심히 키우거든요???? 제발 사주세용</h5>
                          </div>
                ...
                <div class="edit_content">
                  <h2 style="font-weight: bold;">상품문의 모아보기</h2>
                      ...
                      <!-- 상품한줄 시작 -->
                        <div class="row">
                          <div class="col-2">                          
                            <div class="prodLike_img-wrapper" style="position: relative; width: 130px; height: 130px;"><img src="./resources/images/pear.png" class="rounded" alt="물품사진" style=" position: absolute; top: 0; left: 0; transform: translate(50, 50); width: 100%; height: 100%; object-fit: cover; margin: auto;"></div>
                          </div>
                          <div class="col-5">진짜 겨울배가 맛있나요? 뭐가 잘 안되면 겨울 배를 먹으라고 하던데... 진짜인가요??</div>
